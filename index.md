...
**What format should the reports be in?** See the [course schedule](schedule) for details on which reports should be posted on Ed vs. Gradescope. PDF reports must be typeset. On Gradescope, please submit only one assignment per team and make sure you add all your team members to the assignment. 
